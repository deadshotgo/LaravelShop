          ...
          <div class="row active-blog">
            ...
            <div class="col-xs-12">
              <div class="blog-item">
                ...
                <div class="blog-desc">
                  <h5 class="blog-title">
                    <a href="single-blog.html">dummy Blog name</a>
                  </h5>
                  <p>
                    There are many variations of passages of psum available, but
                    the majority have suffered alterat on in some form, by
                    injected humour, randomis words which don't look even
                    slightly.
                  </p>
                  <div class="read-more">
                  ...
                  <ul class="blog-meta">
                    ...
                    <li>
                      <a href="#"
                        ><i class="zmdi zmdi-comments"></i>59 Comments</a
                      >
                    </li>
                    <li>
