                      ...
                      <div class="new-customers">
                        <div class="p-30">
                          ...
                          <div class="checkbox">
                            <label class="mr-10">
                              <small>
                                <input type="checkbox" name="signup" />I wish to
                                subscribe to the 69 Fashion newsletter.
                              </small>
                            </label>
                            <br />
                            <label>
                              <small>
                                <input type="checkbox" name="signup" />I have
                    ...
                    <form action="#">
                      <div class="new-customers p-30">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <button
                              class="submit-btn-1 mt-20 f-right btn-hover-1"
                              type="submit"
                              value="register"
                            >
                              continue
